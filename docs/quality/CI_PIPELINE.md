...
|---|---|---|
| 1 Syntax/Import | `fast` › Gate 1 | `python -m compileall -q server.py runtime.py configuration.py assistant_core.py actions.py config_loader.py app_launcher.py memory.py browser_tools.py monitors.py tts.py health.py screen_capture.py clipboard_tools.py` |
...
```powershell
$env:PYTHONUTF8 = "1"
python -m compileall -q server.py runtime.py configuration.py assistant_core.py actions.py config_loader.py app_launcher.py memory.py browser_tools.py monitors.py tts.py health.py screen_capture.py clipboard_tools.py
