...
| 46 | Zentrale Action-Registry: Label, Payload-Regel, Risk, Timeout, Summary-Prompt, **Ausfuehrung (`execute`) und Prompt-Selbstbeschreibung (`describe`)** pro Aktion in einem `ActionSpec` — der System-Prompt wird daraus erzeugt | [actions.py](actions.py) `REGISTRY` | ✅ vertieft (RFC-0001) |
